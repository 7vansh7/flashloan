...
export declare const ON_DEMAND_MAINNET_QUEUE_PDA: anchor.web3.PublicKey;
...
export declare const ON_DEMAND_DEVNET_QUEUE_PDA: anchor.web3.PublicKey;
/**
 ...
 */
export declare function isDevnetConnection(connection: Connection): Promise<boolean>;
/**
