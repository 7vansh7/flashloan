...
class AnchorUtils {
    ...
    static loadProgramFromEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isDevnet = (0, utils_1.isDevnetConnection)(config.connection);
            let pid = isDevnet ? utils_1.ON_DEMAND_DEVNET_PID : utils_1.ON_DEMAND_MAINNET_PID;
    ...
    static loadEnv() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pid = yield (0, utils_1.getProgramId)(config.connection);
            const idl = (yield anchor.Program.fetchIdl(pid, config.provider));
            const program = new anchor.Program(idl, config.provider);
