...
class Randomness {
    ...
    commitIx(queue, authority_) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (queue.equals(utils_1.ON_DEMAND_MAINNET_QUEUE_PDA) ||
                queue.equals(utils_1.ON_DEMAND_DEVNET_QUEUE_PDA)) {
                const solanaQueue = yield (queue.equals(utils_1.ON_DEMAND_MAINNET_QUEUE_PDA)
                    ? (0, utils_1.getDefaultQueue)()
                    : (0, utils_1.getDefaultDevnetQueue)());
                const solanaOracle = yield solanaQueue.fetchFreshOracle();
                [oracle] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("Oracle"), queue.toBuffer(), solanaOracle.toBuffer()], spl.ON_DEMAND_MAINNET_PID);
            }
            else {
    ...
    revealIx() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (data.queue.equals(utils_1.ON_DEMAND_MAINNET_QUEUE_PDA) ||
                data.queue.equals(utils_1.ON_DEMAND_DEVNET_QUEUE_PDA)) {
            ...
            const stats = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("OracleRandomnessStats"), data.oracle.toBuffer()], this.program.programId)[0];
    ...
    findOracleKeyPDA(oracles, oracleKey) {
        for (const oracle of oracles) {
            const [oraclePDA] = web3_js_1.PublicKey.findProgramAddressSync([Buffer.from("Oracle"), oracle.toBuffer()], this.program.programId);
    ...
    static createAndCommitIxs(program, queue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [newRandomness, creationIx] = yield Randomness.create(program, kp, queue);
            const commitIx = yield newRandomness.commitIx(queue, program.provider.publicKey);
