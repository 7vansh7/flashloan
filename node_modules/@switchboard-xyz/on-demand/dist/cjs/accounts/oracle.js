...
class Oracle {
    ...
    findSolanaOracleFromPDA() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const queue = yield (oracleData.queue.equals(index_js_2.ON_DEMAND_MAINNET_QUEUE_PDA)
                ? (0, index_js_1.getDefaultQueue)()
                : (0, index_js_1.getDefaultDevnetQueue)());
            const solanaOracles = yield queue.fetchOracleKeys();
            for (const oracle of solanaOracles) {
                const [oraclePDA] = yield web3_js_1.PublicKey.findProgramAddress([Buffer.from("Oracle"), oracleData.queue.toBuffer(), oracle.toBuffer()], this.program.programId);
