...
exports.microLamportsToUi = exports.uiToMicroLamports = void 0;
...
exports.decompileV0Transaction = decompileV0Transaction;
exports.legacyTxToV0Tx = legacyTxToV0Tx;
exports.updateV0Tx = updateV0Tx;
exports.compareInstructions = compareInstructions;
exports.replaceV0TxInstructions = replaceV0TxInstructions;
exports.replaceV0TxBlockhash = replaceV0TxBlockhash;
...
exports.getComputeBudgetUnits = getComputeBudgetUnits;
...
function compareInstructions(ix1, ix2) {
    ...
    const keysCompare = ix1.keys.length === ix2.keys.length &&
 ...
 */
const uiToMicroLamports = (ui, limitCU = 1_400_000) => {
    const priorityFeeMicroLamports = ui * web3_js_1.LAMPORTS_PER_SOL * 1_000_000;
    return priorityFeeMicroLamports / limitCU;
};
exports.uiToMicroLamports = uiToMicroLamports;
/**
 ...
 */
const microLamportsToUi = (microLamports, limitCU = 1_400_000) => {
    const priorityFeeMicroLamports = microLamports * limitCU;
    const priorityFeeUi = priorityFeeMicroLamports / (web3_js_1.LAMPORTS_PER_SOL * 1_000_000);
    return Math.trunc(priorityFeeUi * web3_js_1.LAMPORTS_PER_SOL) / web3_js_1.LAMPORTS_PER_SOL;
};
exports.microLamportsToUi = microLamportsToUi;
