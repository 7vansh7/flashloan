...
export declare function replaceV0TxInstructions(additionalInstructions: TransactionInstruction[], instructions: TransactionInstruction[], replaceOnly?: boolean): TransactionInstruction[];
