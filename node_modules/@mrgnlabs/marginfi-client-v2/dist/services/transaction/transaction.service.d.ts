...
import { VersionedTransaction, TransactionSignature, Connection, ConfirmOptions, PublicKey, Commitment, SimulatedTransactionResponse } from "@solana/web3.js";
...
export declare function confirmBundle(connection: Connection, bundleId: string, commitment?: Commitment): Promise<string>;
