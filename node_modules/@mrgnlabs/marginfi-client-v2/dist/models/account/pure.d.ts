import { Amount, BankMetadataMap, InstructionsWrapper } from "@mrgnlabs/mrgn-common";
...
declare class MarginfiAccount {
    ...
    getHealthCheckAccounts(banks: Map<string, Bank>, mandatoryBanks: Bank[] | undefined, excludedBanks: Bank[] | undefined, bankMetadataMap: BankMetadataMap): AccountMeta[];
    ...
    makeWithdrawIx(program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, bankMetadataMap: BankMetadataMap, amount: Amount, bankAddress: PublicKey, withdrawAll?: boolean, opt?: MakeWithdrawIxOpts): Promise<InstructionsWrapper>;
    makeBorrowIx(program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, bankMetadataMap: BankMetadataMap, amount: Amount, bankAddress: PublicKey, opt?: MakeBorrowIxOpts): Promise<InstructionsWrapper>;
    ...
    makeLendingAccountLiquidateIx(liquidateeMarginfiAccount: MarginfiAccount, program: MarginfiProgram, banks: Map<string, Bank>, mintDatas: Map<string, MintData>, bankMetadataMap: BankMetadataMap, assetBankAddress: PublicKey, assetQuantityUi: Amount, liabilityBankAddress: PublicKey): Promise<InstructionsWrapper>;
...
export declare function makeHealthAccountMetas(banks: Map<string, Bank>, banksToInclude: PublicKey[], bankMetadataMap?: BankMetadataMap, authority?: PublicKey): AccountMeta[];
