import { Amount, InstructionsWrapper, TransactionBroadcastType, TransactionOptions, ExtendedTransaction, ExtendedV0Transaction, BankMetadataMap } from "@mrgnlabs/mrgn-common";
import { Address } from "@coral-xyz/anchor";
import { AccountMeta, Commitment, PublicKey, Transaction, TransactionInstruction, Signer, AddressLookupTableAccount, VersionedTransaction, TransactionSignature } from "@solana/web3.js";
import BigNumber from "bignumber.js";
import { LoopTxProps, MakeBorrowIxOpts, MakeDepositIxOpts, MakeRepayIxOpts, MakeWithdrawIxOpts, MarginfiClient, MarginfiGroup, MarginfiIdlType, ProcessTransactionsClientOpts, RepayWithCollateralProps, FlashloanActionResult, LoopProps, TransactionBuilderResult } from "../..";
...
declare class MarginfiAccountWrapper {
     ...
     */
    movePosition(amount: Amount, bankAddress: PublicKey, destinationAccount: MarginfiAccountWrapper, processOpts?: ProcessTransactionsClientOpts, txOpts?: TransactionOptions): Promise<TransactionSignature[]>;
    /**
     ...
     */
    makeMovePositionTx(amount: Amount, bankAddress: PublicKey, destinationAccount: MarginfiAccountWrapper): Promise<TransactionBuilderResult>;
    /**
     ...
     */
    makeRepayWithCollatTxV2({ repayAmount, withdrawAmount, borrowBankAddress, depositBankAddress, withdrawAll, repayAll, swap, blockhash: blockhashArg, withdrawOpts, repayOpts, }: RepayWithCollateralProps): Promise<FlashloanActionResult>;
    loopV2(props: LoopProps): Promise<TransactionSignature[]>;
    makeLoopTxV2({ depositAmount, borrowAmount, depositBankAddress, borrowBankAddress, swap, blockhash: blockhashArg, depositOpts, borrowOpts, setupBankAddresses, }: LoopTxProps): Promise<FlashloanActionResult>;
    /**
     ...
     */
    simulateBorrowLendTransaction(txs: (VersionedTransaction | Transaction)[], banksToInspect: PublicKey[]): Promise<SimulationResult>;
    /**
    ...
    getHealthCheckAccounts(mandatoryBanks: Bank[] | undefined, excludedBanks: Bank[] | undefined, bankMetadataMap: BankMetadataMap, authority: PublicKey): AccountMeta[];
