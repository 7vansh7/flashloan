    ...
    switch (oracleSetup) {
        ...
        case bank_1.OracleSetup.StakedWithPythPush: {
            ...
            const confidenceRealTime = new bignumber_js_1.default(Number(data.priceMessage.conf))
                .times(exponent)
                .times(__1.PYTH_PRICE_CONF_INTERVALS);
            const cappedConfidenceRealTime = capConfidenceInterval(priceRealTime, confidenceRealTime, __1.MAX_CONFIDENCE_INTERVAL_RATIO);
            ...
            const confidenceTimeWeighted = new bignumber_js_1.default(Number(data.priceMessage.emaConf))
                .times(exponent)
                .times(__1.PYTH_PRICE_CONF_INTERVALS);
            const cappedConfidenceWeighted = capConfidenceInterval(priceTimeWeighted, confidenceTimeWeighted, __1.MAX_CONFIDENCE_INTERVAL_RATIO);
