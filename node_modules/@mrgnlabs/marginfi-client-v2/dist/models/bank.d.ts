...
declare class BankConfig {
    ...
    permissionlessBadDebtSettlement: boolean;
    freezeSettings: boolean;
    constructor(assetWeightInit: BigNumber, assetWeightMaint: BigNumber, liabilityWeightInit: BigNumber, liabilityWeightMaint: BigNumber, depositLimit: BigNumber, borrowLimit: BigNumber, riskTier: RiskTier, totalAssetValueInitLimit: BigNumber, assetTag: AssetTag, oracleSetup: OracleSetup, oracleKeys: PublicKey[], oracleMaxAge: number, interestRateConfig: InterestRateConfig, operationalState: OperationalState, permissionlessBadDebtSettlement: boolean, freezeSettings: boolean);
...
export { Bank, BankConfig, RiskTier, OperationalState, OracleSetup, parseRiskTier, parseOracleSetup, serializeBankConfigOpt, computeMaxLeverage, computeLoopingParams, AssetTag, };
