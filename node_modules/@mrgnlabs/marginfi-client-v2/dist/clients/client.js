...
class MarginfiClient {
    ...
    static async fetch(config, wallet, connection, clientOptions) {
        ...
        const idl = { ...__1.MARGINFI_IDL, address: config.programId.toBase58() };
    ...
    static async fetchGroupData(program, groupAddress, commitment, bankAddresses, bankMetadataMap) {
        ...
        const oracleKeys = bankDatasKeyed.map((b) => (0, utils_1.findOracleKey)(__1.BankConfig.fromAccountParsed(b.data.config), feedIdMap));
        ...
        const banks = new Map(bankDatasKeyed.map(({ address, data }) => {
            ...
            const bank = __1.Bank.fromAccountParsed(address, data, feedIdMap, bankMetadata);
