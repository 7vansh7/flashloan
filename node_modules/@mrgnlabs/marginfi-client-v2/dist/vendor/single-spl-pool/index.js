...
exports.createAccountIx = exports.findPoolMintAddressByVoteAccount = exports.findMplMetadataAddress = exports.findPoolMplAuthorityAddress = exports.findPoolMintAuthorityAddress = exports.findPoolStakeAuthorityAddress = exports.findPoolStakeAddress = exports.findPoolMintAddress = exports.findPoolAddress = exports.SinglePoolInstruction = void 0;
...
(function (SinglePoolInstructionType) {
    ...
    SinglePoolInstructionType[SinglePoolInstructionType["ReactivatePoolStake"] = 1] = "ReactivatePoolStake";
...
const SinglePoolInstruction = {
    ...
    reactivatePoolStake: (voteAccount) => {
        const pool = findPoolAddress(voteAccount);
        const stake = findPoolStakeAddress(pool);
        const stakeAuthority = findPoolStakeAuthorityAddress(pool);
        return createTransactionInstruction(mrgn_common_1.SINGLE_POOL_PROGRAM_ID, [
