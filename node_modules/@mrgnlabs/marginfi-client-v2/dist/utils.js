...
async function buildFeedIdMap(bankConfigs, connection) {
    ...
    const feedIdsWithAddresses = bankConfigs
        .filter((bankConfig) => (0, _1.parseOracleSetup)(bankConfig.oracleSetup) == _1.OracleSetup.PythPushOracle)
        .map((bankConfig) => {
...
function findOracleKey(bankConfig, feedMap) {
    ...
    if (oracleSetup == _1.OracleSetup.PythPushOracle || oracleSetup == _1.OracleSetup.StakedWithPythPush) {
