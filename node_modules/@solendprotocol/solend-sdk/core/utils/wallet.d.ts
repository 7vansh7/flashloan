...
export declare function formatWalletAssets(rawWalletData: Awaited<ReturnType<typeof fetchWalletAssets>>, metadata: TokenMetadata, nativeTokenSymbol?: string): import("../types").WalletAssetType[];
